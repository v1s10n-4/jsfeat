...
import { grayscale, sobelDerivatives } from 'jsfeat/imgproc';
...
const demo: Demo = {
  ...
  description: 'Sobel derivative visualization: dx mapped to red, dy mapped to green.',
  ...
  process(
    ...
    sobelDerivatives(gray, derivatives);
    profiler.end('sobel');
